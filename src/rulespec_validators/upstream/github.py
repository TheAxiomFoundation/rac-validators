...
class IssueReport:
    ...
    def to_markdown(self) -> tuple[str, str]:
        ...
        title = f"[rulespec-validators] Potential calculation discrepancy: {self.variable} in {self.test_case}"

        body = f"""## Automated Bug Report

This issue was automatically generated by [rulespec-validators](https://github.com/TheAxiomFoundation/rulespec-validators), a multi-system tax/benefit validation framework.
...
---
*Generated by rulespec-validators. Please verify this is a valid issue before addressing.*
"""
        return title, body
